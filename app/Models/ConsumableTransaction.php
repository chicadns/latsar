...
class ConsumableTransaction extends SnipeModel
{
     ...
     * @var array
     */
    protected $searchableAttributes = ['types', 'state', 'employee_num', 'assigned_to', 'company_id', 'purchase_date', 'notes'];
    ...
    protected $searchableRelations = [
        'company'      => ['name'],
        'assigned_to'  => ['first_name', 'last_name', 'employee_num', 'nip_baru'],
    ];
