...
class SamlController extends Controller
{
    ...
    public function acs(Request $request)
    {
        ...
        //$locations_id = Location::where('manager_id', $nip_baru)->first()->location_id;
        ...
        try{
            ...
            [
                ...
                'employee_num' => $samlAttributes['nip-lama'][0],
                'created_by' => '0',
        ...
        $hasPenggunaRole = DB::table('users_groups')->where('user_id', $nip_baru)->where('group_id', '4')->exists();
        
        if(!$hasPenggunaRole) {
            $user_saml->groups()->sync(['4' => ['user_id' => $nip_baru]], false);    
        }
        } catch (\Exception $e){
            echo $e->errors();
        }
